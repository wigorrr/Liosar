...
<h1 class="titulo_productos_seccion"> SEGURIDAD </h1>
<hr class="division_titulo">

<ul class="lista-productos">
<li><a href="#">Ducha de emergencia</a></li>
<li><a href="#">Lava ojos de emergencia</a></li>
<li><a href="#">Ducha combinada con lava ojos de emergencia</a></li>
<li><a href="#">Estación de emergencia</a></li>
<li><a href="#">Sumidero</a></li>
</ul>
</main>
