...
<h1 class="titulo_productos_seccion"> FILTROS </h1>
<hr class="division_titulo">

<ul class="lista-productos">
<li><a href="#">Filtro de carbón activado</a></li>
<li><a href="#">Filtro de alúmina activada</a></li>
<li><a href="#">Separador de gotas</a></li>
<li><a href="#">Demister</a></li>
</ul>
